    ...
    export default {
        ...
        data: function () {
            return {
                ...
                receiver: '',
                friends: [
                    // {src: require('../assets/img/head1.jpeg'), name: 'Michelle', online: false, Id:'01'},
                    // {src: require('../assets/img/head2.jpg'), name: 'Alex', online: false, Id:'02'},
                    // {src: require('../assets/img/head3.jpeg'), name: 'Fang', online: false, Id:'03'},
                    // {src: require('../assets/img/head4.jpg'), name: 'Yvonne', online: false, Id:'04'},
                ],
                currentFriend: {
                    src: '', name:'', Id:''
                },
